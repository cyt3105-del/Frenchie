...
export default function ConjugationScreen() {
  ...
  const speakCorrectSentence = useCallback(() => {
    ...
    const conjugation = currentVerb.conjugations.present[currentPronounIndex];
    const sentence = `${pronoun} ${conjugation} (${currentVerb.english})`;

    speak(sentence);
  }, [currentVerb, currentPronounIndex, speak]);
